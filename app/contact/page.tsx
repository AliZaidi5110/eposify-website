  ...
  return (
    <PageShell>
      <main>
        ...
        <section className="px-5 pb-20"><SectionHeader eyebrow="Find us" title="UK-based assistance" text="Speak to the Eposify team about payment solutions, POS systems, salon payment systems, restaurant card machine options and business funding." /><div className="mx-auto max-w-7xl overflow-hidden rounded-4xl bg-white shadow-premium"><div className="flex items-center gap-3 p-6 font-black text-navy"><MapPin className="text-electric" /> Serving businesses across the United Kingdom</div><iframe title="Google Maps UK" src="https://www.google.com/maps?q=United%20Kingdom&output=embed" className="h-96 w-full border-0" loading="lazy" /></div></section>
      </main>
    </PageShell>
  );
}
