      ...
      <main>
        <section className="relative overflow-hidden px-5 py-16 md:py-24">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <div className="mb-6 inline-flex flex-wrap items-center gap-3 rounded-full border border-electric/30 bg-navy px-4 py-2 shadow-sm sm:gap-4 sm:px-6 sm:py-3">
                <span className="text-xs font-bold text-white sm:text-sm">Partnered with</span>
                <Image src="/demo-teya.png" alt="Teya" width={100} height={40} className="h-8 w-auto object-contain sm:h-10" />
